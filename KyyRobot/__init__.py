...
LOGGER = logging.getLogger('[Nasty]')
LOGGER.info("Nasty is starting. | An Nasty Project Parts. | Licensed under GPLv3.")
...
if ENV:
    ...
    MONGO_DB = os.environ.get("MONGO_DB", "Nasty")
...
try:
    ...
    raise Exception(
        "[Nasty Error]: Your Redis Database Is Not Alive, Please Check Again."
    )
finally:
    REDIS.ping()
