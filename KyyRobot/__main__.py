...
from KyyRobot.modules import ALL_MODULES
from KyyRobot.modules.helper_funcs.chat_status import is_user_admin
from KyyRobot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("KyyRobot.modules." + module_name)
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(text=gs(chat.id, "about_button"), callback_data="kyy_"),
                        ],
                        [
                            InlineKeyboardButton(text=gs(chat.id, "help_button"), callback_data="help_back"),
                            InlineKeyboardButton(text=gs(chat.id, "music_button"), callback_data="source_"),
                        ],
                        [
    ...
    if query.data == "kyy_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="ᴀᴅᴍɪɴs", callback_data="kyy_admin"),
                        InlineKeyboardButton(text=gs(chat.id, "notes_button"), callback_data="kyy_notes"),
                    ],
                    [
                        InlineKeyboardButton(text=gs(chat.id, "support_chat_link_button"), callback_data="kyy_support"),
                        InlineKeyboardButton(text="ᴄʀᴇᴅɪᴛs", callback_data="kyy_credit"),
                    ],
                 [
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="ҡʏʏ", url="t.me/IDnyaKosong"),
                 ],
                 [
                    InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="kyy_"),
    ...
    if query.data == "source_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="ᴋᴇᴍʙᴀʟɪ", callback_data="kyy_back")
                 ]
                ]
            ),
        )
